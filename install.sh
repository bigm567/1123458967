...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		git clone https://ghproxy.com/https://github.com/233boy/v2ray /etc/v2ray/233boy/v2ray
	fi
	...
	v2ray_ver="$(curl -H 'Cache-Control: no-cache' -s https://ghproxy.com/https://api.github.com/repos/v2ray/v2ray-core/releases/latest | grep 'tag_name' | cut -d\" -f4)"
